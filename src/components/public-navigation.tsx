...
export function PublicNavigation() {
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[color-mix(in_srgb,var(--background)_80%,transparent)] backdrop-blur-[12px]">
      <div className="mx-auto max-w-[1280px] px-12 py-3.5 flex items-center justify-between gap-6">
        ...
        <nav className="hidden md:flex items-center gap-7 text-[13px] text-[var(--fg-muted)]">
          {links.map((l) => (
